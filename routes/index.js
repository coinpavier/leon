...
//BUY
router.get('/buy', forwardAuthenticated, (req, res) => res.render('buy'));


//sell
router.get('/sell', forwardAuthenticated, (req, res) => res.render('sell'));

//Career
router.get('/career', forwardAuthenticated, (req, res) => res.render('career'));


//Join
router.get('/join', forwardAuthenticated, (req, res) => res.render('join'));
